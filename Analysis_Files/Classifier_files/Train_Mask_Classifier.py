...
label_clf_path = clf_path_dir / f"mask_edge_{clf_name}.pkl"
...
side_clf_path = side_clf_path_dir / f"contour_side_{clf_name}.pkl"
joblib.dump(side_clf, side_clf_path)
print(f"Side classifier saved to {side_clf_path}")

cfg['side_clf_path'] = str(side_clf_path)
cfg['label_clf_path'] = str(label_clf_path)
with open("Analysis_Files/config.json", "w") as f:
    json.dump(cfg, f, indent=4)
    print(f"Configuration updated in Analysis_Files/config.json with new classifier paths.")